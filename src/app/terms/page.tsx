 ...
 * Displays Hampstead Renovations terms of service
 */

import React from 'react';
import type { Metadata } from 'next';
import { getTermsOfService } from '@/lib/legal/company-legal-config';
import { COMPANY } from '@/lib/constants/company';

export const metadata: Metadata = {
  title: 'Terms of Service',
  description: `Terms of service for ${COMPANY.name}. Read our terms and conditions for using our property data platform.`,
};
